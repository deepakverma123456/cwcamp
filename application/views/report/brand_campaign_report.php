...
<div class="modal-content">
    ...
    <form action="<?php echo base_url(); ?>report/view_brand_list" id="brandform" method="post" >
        <div class="modal-body">
			<div class="row"><div id="msg"></div></div>			
			<div class="row" style="margin-right: 0px">	
				<div class="row" style="margin-left: 15px">
					<a href="javascript:void(0)" class="searchbrand" id='All'>All</a>
				<?php
				$alpharange = range( 'A', 'Z' ); 
				foreach ( $alpharange as $i ){
					echo "<a href='javascript:void(0)' class='searchbrand' id='".$i."'>"."$i\n"."</a>";
				}
				?>
				</div>
        ...
        <div class="modal-footer">
           <button type="button" class="btn btn-default btn-icon pull-right" data-dismiss="modal"><i class="fa fa-times-circle"></i> Cancel</button>
            <button type="submit" name="submit" id="brasubmit" value="newAccount" class="btn btn-success btn-icon pull-right" disabled><i class="fa fa-check"></i> Submit</button>
