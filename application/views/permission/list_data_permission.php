...
<style>
	...
	#datatable3_wrapper{
		border: 1px solid #dddddd !important; padding:7px !important;
	}
			...
			<div class="x_content">
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12 ">
						...
						<div  id="success-div">
							<div class="alert alert-success alert-dismissable" style="margin-top:7%;position: absolute;width: 90%;">
								<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
...
<script type='text/javascript'>
 $(document).ready(function() {
	...
	$("#tabs").on("click", "li", function(){
		clear_user_tab();
		$('#brand_multi_div').show();
		$('#loading_div').html('<i id="loading" class="btn fsubmit"></i><br/>Choose a user, and continue to create or update permission.').show();
	});
...
function get_domain_data(id)
{
	if(id.value !='')
	{
		...
		$('.dataTables_scrollHeadInner').css({"width": "100% !important","padding-right":"0px"});
