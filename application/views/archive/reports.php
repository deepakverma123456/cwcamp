		  ...
		  <div class="x_content">
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<nav role="navigation" class="col-xs-12 col-md-12 navbar navbar-default">
						<ul class="nav navbar-nav">
						  <li><a href="javascript:void(0)">1.&nbsp;&nbsp;Top 5 Product Campaign Report</a></li>
						</ul>
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<nav role="navigation" class="col-xs-12 col-md-12 navbar navbar-default">
						<ul class="nav navbar-nav">
						  <li><a href="javascript:void(0)">4.&nbsp;&nbsp;Most Active IP Hits Report</a></li>
						</ul>
						<ul class="nav navbar-nav pull-right">
						  <li><a class="navbar-link" href="<?php echo base_url(); ?>archive/mostip_hits_report" title="Download"><span class="fa fa-download"></span>&nbsp;Download</a></li>
						</ul>
					</nav>
				</div>
				<?php }	?>
...
<script type="text/javascript">
  $(document).ready(function() {
	...
	$('#reportrange').on('cancel.daterangepicker', function(ev, picker) {
		$( ".ranges>ul li:nth-child(4)" ).trigger( "click" );
		$('#reportrange span').html(moment().subtract(29, 'days').format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
